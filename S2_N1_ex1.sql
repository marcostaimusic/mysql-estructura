...
-- -----------------------------------------------------
-- Table `S2_N1_ex1`.`vidre_right`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `S2_N1_ex1`.`vidre_right` (
  `vidre_id` INT NOT NULL AUTO_INCREMENT,
  `vidre_color` VARCHAR(45) NULL,
  `vidre_grad` INT(2) NULL,
  PRIMARY KEY (`vidre_id`))
ENGINE = InnoDB;


-- -----------------------------------------------------
-- Table `S2_N1_ex1`.`vidre_left`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `S2_N1_ex1`.`vidre_left` (
  `vidre_id` INT NOT NULL AUTO_INCREMENT,
  `vidre_color` VARCHAR(45) NULL,
  `vidre_grad` INT(2) NULL,
  PRIMARY KEY (`vidre_id`))
...
CREATE TABLE IF NOT EXISTS `S2_N1_ex1`.`ulleres` (
  ...
  `vidre_right_id` INT NOT NULL,
  `vidre_left_id` INT NOT NULL,
  ...
  PRIMARY KEY (`ulleres_id`, `vidre_right_id`, `vidre_left_id`, `montura_id`, `client_id`, `seller_id`, `marca_id`),
  INDEX `fk_ulleres_vidre_right1_idx` (`vidre_right_id` ASC) VISIBLE,
  INDEX `fk_ulleres_vidre_left1_idx` (`vidre_left_id` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_ulleres_vidre_right1`
    FOREIGN KEY (`vidre_right_id`)
    REFERENCES `S2_N1_ex1`.`vidre_right` (`vidre_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ulleres_vidre_left1`
    FOREIGN KEY (`vidre_left_id`)
    REFERENCES `S2_N1_ex1`.`vidre_left` (`vidre_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
