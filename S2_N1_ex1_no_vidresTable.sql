...
-- Schema S2_N1_ex1
-- -----------------------------------------------------
DROP DATABASE IF EXISTS `S2_N1_ex1`;
...
CREATE TABLE IF NOT EXISTS `S2_N1_ex1`.`ulleres` (
  ...
  `seller_id` INT NOT NULL COMMENT 'If null the glass has not been sold yet',
  `marca_id` INT NOT NULL,
  `ulleres_sale_date` DATETIME NOT NULL,
  PRIMARY KEY (`ulleres_id`, `montura_id`, `client_id`, `seller_id`, `marca_id`),
